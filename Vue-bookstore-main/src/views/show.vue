  ...
  <div>
        ...
        <div class="Menu" >
          <el-menu class="el-menu-demo" mode="horizontal" >
            ...
            <el-menu-item index="2" @click="changeByType(type='干果')">干果</el-menu-item>
            <el-menu-item index="3" @click="changeByType(type='糕点')">糕点</el-menu-item>
            <el-menu-item index="4" @click="changeByType(type='糖果类')">糖果</el-menu-item>
            <el-menu-item index="5" @click="changeByType(type='膨化食品')">膨化食品</el-menu-item>
            <el-menu-item index="6" @click="changeByType(type='蛋白质零食')">蛋白质零食</el-menu-item>
          </el-menu>
        </div>
        <div>
          <el-row style="text-align: center;margin-left: 20%;margin-right: 20%"
